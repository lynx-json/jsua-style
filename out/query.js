...
exports.default = _query2.default;
},{"./query":2,"babel-polyfill":"babel-polyfill"}],2:[function(require,module,exports){
"use strict";
...
function matches(selector, element) {
  ...
  var matches = element.matches || element.msMatchesSelector || element.webkitMatchesSelector || element.mozMatchesSelector || element.oMatchesSelector;
...
function executeFunctionOrArrayOfFunctions(fn, element) {
  if (Array.isArray(fn)) {
    return fn.forEach(function (f) {
      return executeFunctionOrArrayOfFunctions(f, element);
    });
  }
...
},{"core-js/fn/regexp/escape":3,"core-js/shim":296,"regenerator-runtime/runtime":297}]},{},[1])("babel-polyfill")
});